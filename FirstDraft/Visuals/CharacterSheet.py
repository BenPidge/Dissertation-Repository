...
from PyQt5.QtWidgets import QWidget, QScrollArea, QGraphicsView, QLabel, QTabWidget, QVBoxLayout, QHBoxLayout, QFrame, \
    QGridLayout, QCheckBox, QPushButton, QRadioButton, QSpacerItem, QSizePolicy
